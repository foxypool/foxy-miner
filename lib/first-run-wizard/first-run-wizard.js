...
class FirstRunWizard {
  ...
  getScavengerDownloadLinkForSystem() {
    switch (os()) {
      ...
      case 'Darwin':
        return 'https://github.com/felixbrucker/foxy-miner/releases/download/0.0.0/scavenger-1.7.8-x86_64-apple-darwin-cpu-gpu.tar.gz';
    }
  }
