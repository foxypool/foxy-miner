...
class Proxy {
  ...
  constructor({upstreamConfigs, proxyIndex, miner, showProxyIndex = false}) {
    ...
    this.miner.subscribe('stats', this.onMinerStats.bind(this));
  }

  onMinerLog(logLevel, msg, resetCursor) {
    const fullMessage = this.showProxyIndex ? `Miner #${this.proxyIndex} | ${msg}` : msg;
