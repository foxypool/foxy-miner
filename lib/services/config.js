...
class Config {
  static get coins() {
    return Object.keys(Config.coinColors);
  }
  ...
  static get poolUrls() {
    return {
      AETH: 'http://miner.aeth.foxypool.cf',
      BHD: 'http://miner.bhd.foxypool.cf',
      BURST: 'http://miner.burst.foxypool.cf',
      DISC: 'http://miner.disc.foxypool.cf',
      LHD: 'http://miner.lhd.foxypool.cf',
      HDD: 'http://miner.hdd.foxypool.cf',
      LAVA: 'http://miner.lava.foxypool.cf',
      XHD: 'http://miner.xhd.foxypool.cf',
      BTB: 'http://miner.btb.foxypool.cf',
    };
  }
