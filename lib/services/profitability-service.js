...
class ProfitabilityService {
  ...
  getBlockReward(miningInfo, coin) {
    switch (coin) {
      case 'bhd':
        return this.useEcoBlockRewards ? 4.5 : 14.25;
      case 'burst':
        const month = Math.floor(miningInfo.height / 10800);
        return Math.floor(10000 * Math.pow(95, month) / Math.pow(100, month));
      case 'boom':
        return this.useEcoBlockRewards ? 40 : 190;
      case 'disc':
        return this.useEcoBlockRewards ? 8 : 17.5; // Basically impossible to reach full rewards consistently
      case 'lhd':
        return this.useEcoBlockRewards ? 10 : 92;
      case 'hdd':
        return this.useEcoBlockRewards ? 110 : 2200;
    }
