...
class Logger {
  ...
  constructor() {
    eventBus.subscribe('log/trace', (msg, resetCursor = false, options = {}) => this.onLogs('trace', msg, resetCursor, options));
    eventBus.subscribe('log/debug', (msg, resetCursor = false, options = {}) => this.onLogs('debug', msg, resetCursor, options));
    eventBus.subscribe('log/info', (msg, resetCursor = false, options = {}) => this.onLogs('info', msg, resetCursor, options));
    eventBus.subscribe('log/error', (msg, resetCursor = false, options = {}) => this.onLogs('error', msg, resetCursor, options));
  }

  onLogs(logLevel, msg, resetCursor, { isMinerLog = false } = {}) {
